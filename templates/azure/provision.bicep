...
// output for database with name suffix [74e4fe]
output azureSqlOutput_74e4fe object = {
  teamsFxPluginId: 'azure-sql'
  databaseName_74e4fe: azureSqlProvision.outputs.databaseName_74e4fe
}

// output for database with name suffix [655a89]
output azureSqlOutput_655a89 object = {
  teamsFxPluginId: 'azure-sql'
  databaseName_655a89: azureSqlProvision.outputs.databaseName_655a89
}